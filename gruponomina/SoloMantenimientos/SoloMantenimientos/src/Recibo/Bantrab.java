 ...
 * @author Jacky
 */
public class Bantrab extends javax.swing.JFrame {

    /**
     * Creates new form Bantrab
     */
    public Bantrab() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recibo/bantrab.jpg"))); // NOI18N
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 480, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("insert into bancobantrab values(?,?,?,?,?,?,?,?,?)");// conexión a la tabla "Jose Alejandro Jeronimo"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bantrab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
