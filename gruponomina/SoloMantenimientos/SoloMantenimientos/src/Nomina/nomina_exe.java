  ...
  double sueldoExtra, comisiones, otrosIngresos,bonficacion =250 ;
    ...
    private void initComponents() {
        ...
        tablita.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Puesto", "Sueldo Ordinario", "Sueldo Extra", "Bonificación", "Comisiones", "Otros", "Total Ingreso", "IGSS", "ISR", "Anticipos", "Descuento Judicial", "Otros", "Total Descuentosl", "Sueldo Líquido", "fecha"
            }
        ));
        ...
        txt_f.setFont(new java.awt.Font("Calibri", 1, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(txt_f, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(305, 305, 305))
 ...
 */
        try {
            ...
            Connection cn= DriverManager.getConnection("jdbc:mysql://localhost/n3","root","");
           ...
           pst.setDouble(8, otrosIngresos);
            ...
            pst.setDouble(16,totDesc);
               pst.setString(17, txt_f.getText().trim());
                    pst.executeUpdate();
            txtnombres.setText("");
            txtpues.setText("");
