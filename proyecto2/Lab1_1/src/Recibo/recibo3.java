 ...
 * @author Alejandro
 */
public class recibo3 extends javax.swing.JFrame {

    /**
     * Creates new form recibo3
     */
    public recibo3() {
        initComponents();
    }
...
/*-----------------------------------------------------------------------------------------------------------------------*/pst.setString(1, TxtNombre1.getText().trim());//Nombre
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(recibo3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
