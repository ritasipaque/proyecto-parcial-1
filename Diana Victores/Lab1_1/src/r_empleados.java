...
private void crearempleado(){ //throws FileNotFoundException{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // CONEXION MYSQL
        try{
           Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/inicio_sesion", "root", "");//conecta a MYSQL  
...
int filas;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
           Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/inicio_sesion", "root", "");//conecta a MYSQL  
            PreparedStatement pst = (PreparedStatement) cn.prepareStatement("insert into concepto values(?,?,?,?,?)");
