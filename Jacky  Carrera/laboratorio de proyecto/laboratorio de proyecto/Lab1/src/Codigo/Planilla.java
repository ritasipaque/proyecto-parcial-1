...
public class Planilla extends javax.swing.JFrame {
    ...
    private void CmdCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmdCalcActionPerformed
        ...
        fila[0]=nombre;
        fila[1]=puesto;
        fila[2]=String.valueOf(sueldo);
        fila[3]=String.valueOf(sueldoExtra);
        fila[4]="154.5";
        fila[5]=String.valueOf(comisiones);
        fila[6]=String.valueOf(otrosIngresos);
        fila[7]=String.valueOf(totIngresos);
        fila[8]=String.valueOf(igss);
        fila[9]="71.98";
        fila[10]=String.valueOf(anticipos);
        fila[11]=String.valueOf(dj);
        fila[12]=String.valueOf(otrosDescuentos);
        fila[13]=String.valueOf(totDesc);
        fila[14]=String.valueOf(sueldoLiquido);
    ...
    private void chequeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chequeActionPerformed
       ...
       int fila =TbData.getSelectedRow();
        ...
        recibo.Txtnombre1.setText(TbData.getValueAt(fila,0).toString());
        recibo.Puesto.setText(TbData.getValueAt(fila,1).toString());
        recibo.Sueldo1.setText(TbData.getValueAt(fila,3).toString());
        recibo.IGSS.setText(TbData.getValueAt(fila,8).toString());
        recibo.ISR.setText(TbData.getValueAt(fila,9).toString());
        recibo.Totales.setText(TbData.getValueAt(fila,14).toString());
